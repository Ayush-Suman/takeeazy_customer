...
class PlaceDetails{
  ...
  static Future<TEResponse> getPlaceDetails(String placeID) async{
    Map<String, String> param  = {'place_id': placeID, 'key': APIKey, 'fields': 'address_component,geometry'};
    TEResponse response = await request<Address>(GoogleAPIURLRoutes.placedetails, call:  CALLTYPE.GET, param: param, isGoogleApi: true);
    return response;
  }
}